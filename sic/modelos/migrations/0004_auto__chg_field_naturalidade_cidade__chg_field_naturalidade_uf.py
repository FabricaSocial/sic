...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Naturalidade.cidade'
        db.alter_column('Naturalidade', 'cidade_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['modelos.Cidade'], null=True))

        # Changing field 'Naturalidade.uf'
        db.alter_column('Naturalidade', 'uf_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['modelos.UF'], null=True))

    def backwards(self, orm):

        # Changing field 'Naturalidade.cidade'
        db.alter_column('Naturalidade', 'cidade_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['modelos.Cidade']))

        # Changing field 'Naturalidade.uf'
        db.alter_column('Naturalidade', 'uf_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['modelos.UF']))
