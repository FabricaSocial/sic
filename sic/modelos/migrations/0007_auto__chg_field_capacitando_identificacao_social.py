...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Capacitando.identificacao_social'
        db.alter_column('Capacitando', 'identificacao_social', self.gf('django.db.models.fields.BigIntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Capacitando.identificacao_social'
        db.alter_column('Capacitando', 'identificacao_social', self.gf('django.db.models.fields.BigIntegerField')(default=None))
