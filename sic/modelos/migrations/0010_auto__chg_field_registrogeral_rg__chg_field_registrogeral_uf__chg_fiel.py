...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'RegistroGeral.rg'
        db.alter_column('RegistroGeral', 'rg', self.gf('django.db.models.fields.BigIntegerField')(null=True))

        # Changing field 'RegistroGeral.uf'
        db.alter_column('RegistroGeral', 'uf_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['modelos.UF'], null=True))

        # Changing field 'RegistroGeral.orgao_expedidor'
        db.alter_column('RegistroGeral', 'orgao_expedidor', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

    def backwards(self, orm):

        # Changing field 'RegistroGeral.rg'
        db.alter_column('RegistroGeral', 'rg', self.gf('django.db.models.fields.BigIntegerField')(default=None))

        # Changing field 'RegistroGeral.uf'
        db.alter_column('RegistroGeral', 'uf_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['modelos.UF']))

        # Changing field 'RegistroGeral.orgao_expedidor'
        db.alter_column('RegistroGeral', 'orgao_expedidor', self.gf('django.db.models.fields.CharField')(default=None, max_length=255))
