...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('Turno', 'saida_lanche', self.gf('django.db.models.fields.TimeField')(null=True))

        # Changing field 'Turno.saida'
        db.alter_column('Turno', 'saida', self.gf('django.db.models.fields.TimeField')(null=True))

        # Changing field 'Turno.entrada'
        db.alter_column('Turno', 'entrada', self.gf('django.db.models.fields.TimeField')(null=True))

        # Changing field 'Turno.entrada_lanche'
        db.alter_column('Turno', 'entrada_lanche', self.gf('django.db.models.fields.TimeField')(null=True))
    ...
    models = {
        ...
        u'modelos.turno': {
            ...
            'descricao': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True'}),
            'entrada': ('django.db.models.fields.TimeField', [], {'null': 'True'}),
            'entrada_lanche': ('django.db.models.fields.TimeField', [], {'null': 'True'}),
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'saida': ('django.db.models.fields.TimeField', [], {'null': 'True'}),
            'saida_lanche': ('django.db.models.fields.TimeField', [], {'null': 'True'}),
