...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'RegistroGeral.data_expedicao'
        db.alter_column('RegistroGeral', 'data_expedicao', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):

        # Changing field 'RegistroGeral.data_expedicao'
        db.alter_column('RegistroGeral', 'data_expedicao', self.gf('django.db.models.fields.DateField')(default=None))
