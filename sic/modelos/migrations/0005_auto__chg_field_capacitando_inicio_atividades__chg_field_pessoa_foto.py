...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Pessoa.foto'
        db.alter_column('Pessoa', 'foto', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Pessoa.foto'
        db.alter_column('Pessoa', 'foto', self.gf('django.db.models.fields.CharField')(default=None, max_length=255))
